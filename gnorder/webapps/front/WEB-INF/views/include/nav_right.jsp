    ...
    <div class="aside__lnb-inner">
        ...
        <div class="aside__scroll">
            <ul class="aside__lnb-list">
                <li><a href="<%=SystemConstant.ORDER%>">온라인 주문</a></li>
                <li class="list-arrow">
                    <a href="#none">메뉴소개</a>
                    <ul class="dept">
                        <li><a href="/menu/menu_list?class_id=10">치킨</a></li>
                        <li><a href="/menu/menu_list?class_id=11">피자</a></li>
                        <li><a href="/menu/menu_list?class_id=12">디저트</a></li>
                        <li><a href="/menu/menu_list?class_id=13">치PD</a></li>
                    </ul>
                </li>
                <li>
                ...
                <li class="list-arrow">
                    <a href="#none">창업안내</a>
                    <ul class="dept">
                        <li><a href="/brd/const/franchise">프랜차이즈굽네</a></li>
                        <li><a href="/brd/const/process">창업프로세스 및 예상비용</a></li>
                        <li><a href="/brd/const/write">온라인 창업상담</a></li>
                    </ul>
                </li>
                <li class="list-arrow">
                    <a href="#none">브랜드</a>
                ...
                <li>
                    <a href="/brd/customer/write">고객의소리</a>
                </li>
                <li>
                    <a href="/brd/notice/list">공지사항</a>
                </li>                
            </ul>
            <dl class="aside__num">
                <dt>주문전화</dt>
