                    ...
                    <section class="founded__cost">
                        <table class="cost-table">
                            ...
                            <tbody>
								...
								<tr>
                                    <td>필수장비 지원(22년도까지)</td>
                                    <td>
                                        <span class="l-num">-320</span>
                                    </td>
                                    <td>
                                        <span class="l-num">-320</span>
                                    </td>
                                ...
                                <tr class="last">
                                    ...
                                    <td colspan="3">
                                        ...
                                        창호교체, 외부창고설치, 워크인 쿨러, 배수 별도공사, 그리스텝 설치공사, 온수기, DID 구입<br>
										후드/덕트 추가라인공사, 배전반 설치공사, TV브라켓 설치
                                    </td>
                                    <td>
                                        직접 비용<br>
                                        (점포에 따라 상이함)
                                ...
                                <tr>
                                    <td>합계</td>
                                    <td>
                                        <span class="l-num">7,535</span>
                                    </td>
                                    <td>
                                        <span class="l-num">9,245</span>
                                    </td>
                                    <td>
                                        <span class="l-num">10,445</span>
                                    </td>
                                    <td>
